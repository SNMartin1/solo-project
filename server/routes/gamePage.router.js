      ...
      if(err) {
        ...
        game.save(function(err){
          ...
          res.sendStatus(500);
            ...
            res.sendStatus(200);
          } //end of else statement for sendStatus
        }); //end of game.save function
      } //end of else statement with session data
  }); //end of Game.findById
}); //end of put route to update game session information.
